...
//: ---
//:
//: This has been investigated. The issue here was that we've always advanced to the next line after adding a point, even if there might be another intersection alone the current line to consider.
//:
//: Fixing this resolved both issues above.
